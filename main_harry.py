...
import datasets
from dataset import MTSD_Dataset, get_transforms
...
def main(args):
    ...
    dataset_train = MTSD_Dataset(dataset_dir = "/data/backdoor_yolo/YOLO_BLUE_MULTI_24K/images/train", label_dir = "/data/backdoor_yolo/YOLO_BLUE_MULTI_24K/labels/train",
                    transforms = get_transforms())
    
    dataset_val = MTSD_Dataset(dataset_dir = "/home/harry/detr/BLUE_LOW_YOLO_CLEAN/images/val", label_dir = "/home/harry/detr/BLUE_LOW_YOLO_CLEAN/labels/val",
                       transforms = get_transforms())
